  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      >
        ...
        <Tab.Screen name="Resource Library" component={ResourceLibraryScreen} />
        <Tab.Screen name="Messages" component={TeacherChatScreen} />
...
const styles = StyleSheet.create({
  ...
  badgeFallback: { width: 32, height: 32, borderRadius: 16, backgroundColor: '#3B82F6', justifyContent: 'center', alignItems: 'center' },
